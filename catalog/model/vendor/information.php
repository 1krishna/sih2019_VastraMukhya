<?php
class ModelVendorInformation extends Model {
	public function addInformation($data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "vendor_to_information WHERE information_id = '" . (int)$information_id . "'");
		$this->db->query("INSERT INTO " . DB_PREFIX . "vendor_to_information SET information_id = '" . (int)$information_id . "', vendor_id = '" . $this->vendor->getId() . "'");
	...
	public function getInformations($data = array()) {
		if ($data) {
			$sql = "SELECT * FROM " . DB_PREFIX . "information i LEFT JOIN " . DB_PREFIX . "information_description id ON (i.information_id = id.information_id) LEFT JOIN " . DB_PREFIX . "vendor_to_information v2i ON (i.information_id = v2i.information_id) WHERE id.language_id = '" . (int)$this->config->get('config_language_id') . "' and v2i.vendor_id<>0";
	...
	public function getTotalInformations($data) {
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "information i LEFT JOIN " . DB_PREFIX . "information_description id ON (i.information_id = id.information_id) LEFT JOIN " . DB_PREFIX . "vendor_to_information v2i ON (i.information_id = v2i.information_id) WHERE id.language_id = '" . (int)$this->config->get('config_language_id') . "' and v2i.vendor_id<>0";
		if(isset($data['vendor_id'])){
			$sql .= " and vendor_id='".$data['vendor_id']."'";
		}
		$query = $this->db->query($sql);
