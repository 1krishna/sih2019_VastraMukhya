...
class ControllerVendorFileManager extends Controller {
	public function index() {
		...
		$vendorfolder=DIR_IMAGE . 'catalog/'.$this->vendor->getId();
		/// 09 08 2018 ///
		$vendorfolder1=DIR_IMAGE . 'catalog/';
		/// 09 08 2018 ///
		...
		foreach ($images as $image) {
			...
			if (is_dir($image)) {
				...
				$data['images'][] = array(
					...
					'href'  => $this->url->link('vendor/filemanager', '&directory=' . urlencode(utf8_substr($image, utf8_strlen(DIR_IMAGE . 'catalog/'))) . $url, true)
				);
