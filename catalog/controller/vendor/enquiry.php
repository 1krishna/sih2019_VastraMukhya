...
class ControllerVendorEnquiry extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$product_info = $this->model_vendor_product->getProduct($result['product_id']);
		...
		$data['sort_name'] = $this->url->link('vendor/enquiry', 'sort=name' . $url, 'SSL');
		$data['sort_email'] = $this->url->link('vendor/enquiry', 'sort=email' . $url, 'SSL');
		$data['sort_product'] = $this->url->link('vendor/enquiry','sort=product' . $url, 'SSL');
		$data['sort_customer'] = $this->url->link('vendor/enquiry','sort=customer' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('vendor/enquiry','sort=status' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('vendor/enquiry','sort=date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('vendor/enquiry',$url . 'page={page}', 'SSL');
		...
		if(isset($data['filter_product'])){
			$product_info = $this->model_vendor_product->getProduct($data['filter_product']);
		}
		if(isset($product_info['name'])){
			$names = $product_info['name'];
		} else {
			$names = '';
		}
		$data['filter_product'] = $names;
