...
class ModelVendorNotification extends Model {
	...
	public function deleteNotification($notification_id) {
		$sql="delete  from " . DB_PREFIX . "vendor_notification where notification_id='".$notification_id."'";
		$query=$this->db->query($sql);
		$sql="delete  from " . DB_PREFIX . "vendor_notification_message where notification_id='".$notification_id."'";
		$query=$this->db->query($sql);
		$sql="delete  from " . DB_PREFIX . "vendor_notification_customer where notification_id='".$notification_id."'";
		$query=$this->db->query($sql);
		$sql="delete  from " . DB_PREFIX . "vendor_notification_seller where notification_id='".$notification_id."'";
		$query=$this->db->query($sql);
	}
